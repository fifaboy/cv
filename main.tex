...
\cventry{$2019$}{Senior Data Scientist, August $4$ to present}{Shohoz}{Dhaka}{}{At Shohoz, I am responsible for building a data pipeline in Azure, user profiling and clustering, data mining on a particular service, fraud analysis and exploratory data analysis e.g. using \texttt{PySpark}. I have also worked on AWS based data pipeline using Kafka as message queue service.}
