...
\cventry{$2019$}{Senior Data Scientist, August $2019$ to present}{Shohoz}{Dhaka}{}{
	My work at Shohoz.
	\begin{itemize}
		\item Successfully completed data pipelines, analytics and visualization and scalable data storage solution for Corona Tracer Bangladesh, a joint venture by Bangladesh government and Shohoz. Tech stacks: \texttt{PySpark, Cassandra, Bokeh, Pandas, Holoviews}, etc. This project is live at \texttt{http://tracer-admin.ctbd.corona-dghs.xyz/}
...
\cvitem{Gaming}{Playing Dota $2$, Assassin Creed games, etc.}
