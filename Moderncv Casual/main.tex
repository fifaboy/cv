...
\cventry{$2016$}{Data Analysis}{Web server log analysis and prediction of vulnerability}{}{}{I did this project under \textit{Threat Equation PTE Ltd, Singapore}. Analyzed web server logs to predict attacks on a particular site. For the internal logs, accuracy was $100\%$ with mean absolute error $0\%$. Though accuracy would be reduced for external logs.}
\cventry{$2016$}{Web Application}{Dashboard}{}{}{This was another project I initially worked on under Threat Equation PTE LTD. as well. The objective was to build a dashboard using \textbf{Django} that would collect data from a plugin and show using javascript and some other tools.}
...
\cventry{$2017$}{Artificial Intelligence}{Belief Propagation Simulator}{Platform: C++}{This project was a simulation of the \textbf{belief propagation}, an established technique in artificial intelligence.}{}
